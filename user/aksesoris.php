...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['id_barang'], $_POST['jumlah'])) {
    ...
    $q = $koneksi->query("SELECT harga_212238, stok_212238 FROM aksesoris_212238 WHERE id_212238 = '$id_barang'");
    ...
    if ($dataBarang) {
        ...
        if ($jumlah > 0 && $stok >= $jumlah) {
            ...
            // Kurangi stok
            $koneksi->query("UPDATE aksesoris_212238 SET stok_212238 = stok_212238 - $jumlah WHERE id_212238 = '$id_barang'");
...
<div class="container py-5">
    <h2 class="text-center text-maroon fw-bold mb-4">Koleksi Aksesoris Hewan</h2>
                    ...
                    <div class="card border-0 shadow h-100 product-card">
                        ...
                        <div class="card-footer bg-white border-0">
                            ...
                            <button type="button" class="btn btn-maroon w-100"
                                onclick="<?= $isUserLoggedIn ? "showOrderPopup('{$data['id_212238']}', '{$data['nama_aksesoris_212238']}', {$data['harga_212238']})" : "showLoginPopup()" ?>"
