...
<div class="container mt-5">
  <h3 class="text-danger mb-4">Tambah Dokter</h3>
  <form action="../proses/tambah.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="spesialis_212238" class="form-control" required>
    </div>

    <div class="mb-3">
      <label>No. STR</label>
      <input type="text" name="no_str_212238" class="form-control" required>
    </div>
    ...
    <div class="mb-3">
      ...
      <textarea name="jadwal_praktek_212238" class="form-control" rows="3" required></textarea>
    </div>
    ...
    <input type="hidden" name="role_212238" value="dokter">

    <button type="submit" name="simpan_dokter" class="btn btn-danger">Simpan</button>
