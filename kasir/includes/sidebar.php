...
<div class="sidebar bg-dark text-white p-3" style="min-height: 100vh; width: 250px; position: fixed;">
  <div class="text-center mb-4">
    <h4 class="fw-bold">Kasir Panel</h4>
    <hr class="text-light">
  </div>
  ...
  <!-- ML System Menu -->
  <div class="mb-2">
    <div class="text-success fw-bold px-3 py-2" style="font-size: 0.85rem;">
      <i class="bi bi-robot me-2"></i> ML SYSTEM
    </div>
    <?php
    echo sidebarLink('prediksi_penjualan.php', 'bi-graph-up-arrow', 'AI Sales Assistant', $mode);
    ?>
  </div>
</div>
