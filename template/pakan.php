...
<!-- SweetAlert2 untuk popup login -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

<div class="container py-5" id="pakan">
  <h2 class="text-center mb-4 text-maroon fw-bold">Koleksi Pakan Hewan</h2>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="card border-0 shadow h-100 product-card">
            <img src="../assets/pakan/<?= htmlspecialchars($data['foto_212238']) ?>"
                 class="card-img-top"
                 alt="<?= htmlspecialchars($data['nama_pakan_212238']) ?>"
            ...
            <div class="card-footer bg-white border-0">
              ...
              <button type="button" class="btn btn-maroon w-100" onclick="promptLogin()">
                Pesan Sekarang
              </button>
            </div>
          </div>
...
function promptLogin() {
  Swal.fire({
    title: 'Harap Login',
    text: 'Anda harus login untuk memesan pakan.',
    icon: 'info',
