...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM users_212238 WHERE id_212238 = '$id' AND role_212238 = 'dokter'");
...
<div class="container mt-5">
  <h3 class="text-danger mb-4">Edit Dokter</h3>
  <form action="../proses/edit.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="spesialis_212238" class="form-control" value="<?= htmlspecialchars($data['spesialis_212238']); ?>" required>
    </div>

    <div class="mb-3">
      <label>No. STR</label>
      <input type="text" name="no_str_212238" class="form-control" value="<?= htmlspecialchars($data['no_str_212238']); ?>" required>
    </div>
    ...
    <div class="mb-3">
      ...
      <textarea name="jadwal_praktek_212238" class="form-control" rows="3" required><?= htmlspecialchars($data['jadwal_praktek_212238']); ?></textarea>
    </div>
    ...
    <button type="submit" name="update_dokter" class="btn btn-danger">Update</button>
